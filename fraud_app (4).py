    ...
    if uploaded_file is not None:
        try:
            ...
            if model is not None and tfidf is not None:
                ...
                st.download_button("📥 Download Results as CSV", data=test_df.to_csv(index=False).encode(), file_name="fraud_predictions.csv", mime="text/csv")
        ...
        st.info("👈 Upload a CSV file from the left panel to begin analysis.")
